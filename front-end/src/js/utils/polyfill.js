...
if (!Array.prototype.forEach) {
  ...
  Array.prototype.forEach = function (callback/*, thisArg*/) {
    ...
    while (k < len) {
      ...
      // operator. b. Let kPresent be the result of calling the HasProperty
      // internal method of O with argument Pk.    This step can be combined with c.
...
if (!Array.prototype.findIndex) {
  Object.defineProperty(Array.prototype, 'findIndex', {
    value: function (predicate) {
      ...
      while (k < len) {
        // a. Let Pk be ! ToString(k). b. Let kValue be ? Get(O, Pk). c. Let testResult
        // be ToBoolean(? Call(predicate, T, « kValue, k, O »)). d. If testResult is
        // true, return k.
        var kValue = o[k];
